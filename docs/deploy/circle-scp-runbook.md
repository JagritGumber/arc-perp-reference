...
- The deploy artifacts bundle: download from the latest green `solidity` workflow run on GitHub Actions. Look for the `arc-perp-reference-deploy-artifacts` artifact at the bottom of the run page.
